...
async function editTransaction(params) {
  ...
  try {
    ...
    if (params.status == 3) {
      ...
      let insertTxn= {}
      if(editTransaction){
        insertTxn.accountNumberFrom= editTransaction.accountNumberFrom ,
        insertTxn.accountNumberTo= editTransaction.accountNumberTo,
        insertTxn.IFSCcode= editTransaction.IFSCcode ,
        insertTxn.bankName= editTransaction.bankName,
        insertTxn.senderUserId= editTransaction.senderUserId ,
        insertTxn.receiverUserId= editTransaction.receiverUserId,
        insertTxn.senderAccountTypeId= editTransaction.senderAccountTypeId,
        insertTxn.couponWalletAmount= editTransaction.couponWalletAmount,
        insertTxn.senderAccountBalance= editTransaction.senderAccountBalance,
        insertTxn.receiverAccountBalance= editTransaction.receiverAccountBalance,
        insertTxn.transactionAmount= editTransaction.transactionAmount,
        insertTxn.transactionType= editTransaction.transactionType,
        insertTxn.status= editTransaction.status,
        insertTxn.remark= editTransaction.remark,
