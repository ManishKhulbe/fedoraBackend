  ...
  try {
    ...
    if (params.status == 3) {
      ...
      if(editTransaction){
        ...
        insertTxn.receiverAccountTypeId= editTransaction.receiverAccountTypeId,
        insertTxn.couponWalletAmount= editTransaction.couponWalletAmount,
        insertTxn.senderAccountBalance= editTransaction.receiverAccountBalance,
        ...
        insertTxn.status= 2,
        insertTxn.remark= `Amount Refunded for your transactionID ${editTransaction._id}`,
