...
function deleteAccount(params){
    ...
    if(params.accountStatus){
        return customerAccountDao.editAccountStatus(params)
    }
}
function editAccount(params){
    return customerAccountDao.editAccount(params)
}
...
function initiateTransaction(senderAccount ,receiverAccount , params ,status){
    return transactionDao.initiateTransaction(senderAccount ,receiverAccount , params ,status)
}
function getSenderAccountDetails(params){
    return customerAccountDao.getSenderAccountDetails(params)
}

function getReceiverAccount(params){
    return customerAccountDao.getReceiverAccount(params)
}
function getAllSequenceKeys(params){
    return shareDao.isSequenceExists(params)
}
function setSequenceNumber(keyName , keyValue){
