...
async function fundTransfer(params) {
  ...
  // console.log(params ,"vvv")
  // try {
  let self = this;
  // await session.withTransaction((mk) => { 
                ...
                return customerAccountService
                  ...
                  .then(function (result) {
                    if (result) {
                      ...
                      return customerAccountService
                        .fundCredit(self.result1 , params)
                        .then(function (result) {
                          if (result) {
                            self.fundCredit = result
                            return customerAccountService.createTransaction(self.fundDebit ,self.fundCredit , params ,1).then(async function(transactionDetails){
