  ...
  return customerAccountService
    ...
    .then(async (isExist) => {
      ...
      switch(self.accountDetails.accountType){
        case 1:
          accountNumberSeqKey = await redisClient.getSequenceNumber("accountNumberSeqKey1");
          keyInRedis ="accountNumberSeqKey1"
          break;
          case 2:
            accountNumberSeqKey = await redisClient.getSequenceNumber("accountNumberSeqKey2");
            keyInRedis ="accountNumberSeqKey2"
            break;
          case 3:
            accountNumberSeqKey = await redisClient.getSequenceNumber("accountNumberSeqKey3");
            keyInRedis ="accountNumberSeqKey3"
            break;
          case 4:
            accountNumberSeqKey = await redisClient.getSequenceNumber("accountNumberSeqKey4");
            keyInRedis ="accountNumberSeqKey4"
            break;
          case 5:
            accountNumberSeqKey = await redisClient.getSequenceNumber("accountNumberSeqKey5");
            keyInRedis ="accountNumberSeqKey5"
            break;
          case 6:
            accountNumberSeqKey = await redisClient.getSequenceNumber("accountNumberSeqKey6");
            keyInRedis ="accountNumberSeqKey6"
            break;
          case 7:
            accountNumberSeqKey = await redisClient.getSequenceNumber("accountNumberSeqKey7");
