    ...
    if (isExist) {
      ...
      return redisClient
        ...
        .then(function (data) {
          if (data) {
            return appUtils
              .sendSmsToUser(isExist.mobileNo, `Hello ${isExist.name}, your verification OTP for the fund transfer is ${self.payload.otp}. Please enter this code to complete your transaction. Thank you for using our service. - FEDORA mBANKING`)
              .then((data) => {
