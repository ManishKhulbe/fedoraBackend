...
function getAdminDashBoardMapping(totalNoOfUser,totalNoOfAccount,totalNoOfAccountByType,pendingOnlineServices ,pendingOnlineServicesByType ,pendingGrievance){
  
  var respObj = {
    message: "fetched successfully",
    totalNoOfUser,totalNoOfAccount,totalNoOfAccountByType,pendingOnlineServices,pendingOnlineServicesByType,pendingGrievance
  };
  return respObj;
}
...
function addOtherBankDetailsMapping(params){
  var respObj ={
    message : "fetched successfully",
    userDetails : {
      customerId : params._id,
...
function deleteOtherBankDetailsMapping(params){
console.log("🚀 ~ file: userMapper.js:491 ~ deleteOtherBankDetailsMapping ~ params", params)
...
function setTxnLimitMapping(params){
  var respObj ={
    message : "fetched successfully",
    _id : params._id,
    name : params.name,
    mobileNo : params.mobileNo,
    odaLimit :  params.odaLimit,
    laaLimit : params.laaLimit
  }
  return respObj;
} 

function editSequenceKeyInRedisMapping(updatedRedisKey){
  var respObj ={
    message : "edit redis sequence key successfully ",
    updatedRedisKey
  }
  return respObj;
}

function addSequenceMapping(params){
  var respObj ={
...
function editSequenceMapping(params){
  var respObj ={
    message : "edit sequence successfully ",
    params
  }
  return respObj;
}
...
module.exports = {
  ...
  addOtherBankDetailsMapping,
  deleteOtherBankDetailsMapping,
  setTxnLimitMapping,
  editSequenceKeyInRedisMapping,
  addSequenceMapping,
  editSequenceMapping
};
