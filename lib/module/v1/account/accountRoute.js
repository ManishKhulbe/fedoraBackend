...
router
  .route("/create")
  .post(
    [middleware.authenticate.autntctTkn, validators.validateAccountDetails],
    function (req, res) {
      console.log(req.user);
      var { accountType, accountInterestRate } = req.body;
...
router
  ...
  .put([middleware.authenticate.autntctTkn], function (req, res) {
    let { userType, userId } = req.user;
    let { accountId, accountType,  accountInterestRate } = req.body;
