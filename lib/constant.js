...
const MESSAGES = {
	...
	SESSION_EXPIRED         : "Your session has expired due to login in another device.",
		...
		SEQUENCE_EXISTS: "Sequence already exists , Please edit previous sequence",
		SEQUENCE_KEY_NOT_FOUND: "Sequence key not found",
		UNABLE_TO_UPDATE_SEQUENCE : "Unable to update sequence",
		INVALID_SECRET_CODE : "Invalid secret code",
		SHARES_EXISTS : "Shares already exists Please update shares value",
		TOO_MANY_REQUESTS : "Too many requests try again after 1 min ",
		SET_MIN_BALANCE_LIMIT_EXCEEDED : "Set minimum balance limit exceeded",
	}
