...
const MESSAGES = {
	...
	SESSION_EXPIRED         : "Your session has expired due to login in another device.",
		...
		ACCOUNTNO_NOT_EXISTS :"Entered account number Doesn't exist",
		...
		INTEREST_TYPE_NOT_EXISTS :'Interest type not exists',
		...
		KEY_SHOULD_BE_POSITIVE_INTEGER :'key should be positive integer',
}
