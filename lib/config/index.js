...
var cfg = {
	...
	s3: {
        ...
        ssl:{
                key:fs.readFileSync(path.join('/home/mobcoder/FEDORA-INDIA/fedoraindia-backend' , 'cert' , 'key.pem' ) ),
                cert:fs.readFileSync(path.join('/home/mobcoder/FEDORA-INDIA/fedoraindia-backend' , 'cert' , 'cert.pem' ) ),
        },
