...
module.exports = {
    ...
    notAbleToSendMail : ()=>{
        return new Exception(50, constants.MESSAGES.NOT_ABLE_TO_SEND_MAIL)
    },
    sequenceExists : ()=>{
        return new Exception(51, constants.MESSAGES.SEQUENCE_EXISTS)
    },
    sequenceKeyNotFound : ()=>{
        return new Exception(52, constants.MESSAGES.SEQUENCE_KEY_NOT_FOUND)
    },
    unableToUpdateSequence : ()=>{
        return new Exception(53, constants.MESSAGES.UNABLE_TO_UPDATE_SEQUENCE)
    },
    invalidSecretCode : ()=>{
        return new Exception(54, constants.MESSAGES.INVALID_SECRET_CODE)
    },
    sharesExists : ()=>{
        return new Exception(55, constants.MESSAGES.SHARES_EXISTS)
    },
    tooManyRequest : ()=>{
        return new Exception(56, constants.MESSAGES.TOO_MANY_REQUESTS)
    },
    setMinBalanceLimitExceeded  :(minBalance)=>{
        return new Exception(57, constants.MESSAGES.SET_MIN_BALANCE_LIMIT_EXCEEDED + minBalance)
    }
